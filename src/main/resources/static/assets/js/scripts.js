(function($) {
    var allfunction = {
        ...
        menu_toggle: function() {
            $('.hamgurger').on("click", function(e) {
                ...
                if ($(".main-menu").hasClass('active')) {
                    $('.hdr-cart-dtls, .hdr-search').removeClass('active');
                    $("body").addClass('overlay');
                } else {
                    $("body").removeClass('overlay');
                    // $(".main-menu ul li").removeClass('active').find('.sub-menu,.mega-menu').slideUp();
                    $('.sub-menu,.mega-menu').slideUp().parents('li').removeClass('active');
                    $('.single-menu .title').removeClass('active').next().slideUp();
                }
            });
            $('.main-menu ul li').click(function(e) {
                ...
                $(this).toggleClass('active').siblings().removeClass('active').find('.sub-menu,.mega-menu').slideUp();
            });
        },
        // ===================== Mega Menu ===============
        mega_menu: function() {
            ...
            e.stopPropagation();
                $(this).toggleClass('active').next().slideToggle().parents().siblings().children().removeClass('active').next('.menu').slideUp();
            });
        },

        //================ MP Order History Table ==================
        mp_history_table: function(){
            $('#mp-hstry-table', ).DataTable({
                responsive: true,
                "searching": false,
                "paging": false,
                "info": false,
        ...
        cart_details: function(){
            $('.hdr-cart').on("click", function(e) {
                e.stopPropagation()
                $('.hdr-cart-dtls').toggleClass('active');
                if ($(".hdr-cart-dtls").hasClass('active')) {
                    $('.main-menu, .hdr-srch, .hmbrgr-icon').removeClass('active');
                    $("body").addClass('overlay');
                  } else {
                    $("body").removeClass('overlay');
                  }
        ...
        search_toogle: function(){
            $('.hdr-srch').on("click", function(e) {
                e.stopPropagation();
                $('.hdr-search').addClass('active');
                if($(".hdr-search").hasClass('active')) {
                    $('.main-menu, .hdr-cart-dtls, .hmbrgr-icon').removeClass('active');
                    $("body").addClass('overlay');
                  } else {
                    $("body").removeClass('overlay');
                  }
            });
            $('.hdeClose').on("click", function(e) {
                e.stopPropagation();
        ...
        aboutGallery: function() {
            if ($('.abutGallery-wrapper').length) {
                // init Isotope
                var $grid = $('.abutGallery-wrapper').isotope({
                    itemSelector: '.aGallery-item',
                    percentPosition: true,
                    masonry: {
                        columnWidth: '.aboutGrid-sizer',
                    }
                });
        ...
        // Food Details Slider 
        foodDetails_slider: function() {
            $(".foodDetails-slider").owlCarousel({    
                // loop:true,
                items:1,
                margin:0,
                stagePadding: 0,
        ...
        // Food Review Slider
        foodReview_slider: function() {
            $('.fd-review').owlCarousel({
                loop:false,
                margin:20,
                dots: true,
        ...
        // Shop Category Toogel
        shop_category: function() {
            $('.single-fdCtgry-item .title').on("click", function() {
        ...
        // Hv1 Banner Slider 
        hv1Banner_slider: function() {
            $('.hv1-banner-wrapper').owlCarousel({
                loop:true,
                margin:20,
                dots: true,
                responsiveClass:true,
        ...
        // Mouse Hover Efect 
        mouseIn: function() {
            $('.single-hv1-gallery').hover(
                function() {
                  $('.single-hv1-gallery').addClass("overlay");
                  $(this).removeClass("overlay");
                },
            );
            $('.single-hv1-gallery').mouseleave(function(){
                $('.single-hv1-gallery').removeClass("overlay");
            })
        },
        ...
        // Hv1 Testimonial Slider ===================
        hv1testimonial_slider: function() {
            $('.hv1-tstimnl-wrapper').owlCarousel({
                loop:true,
                dots: false,
                responsiveClass:true,
                items: 1,
                ...
                autoplayHoverPause:false,
                nav: true,
                navText: ['<span class="iconify" data-icon="dashicons:arrow-left-alt2"></span>','<span class="iconify" data-icon="dashicons:arrow-right-alt2"></span>'],
            })
        },

        // Hv3 Banner Slider 
        hv3Banner_slider: function() {
            $('.hv3-banner-wrapper').owlCarousel({
                loop:true,
                dots: true,
                responsiveClass:true,
                items: 1,
        ...
        // Hv1 Testimonial Slider 
        hv3testimonial_slider: function() {
            $('.hv3-testimonial').owlCarousel({
                loop:true,
                dots: false,
                responsiveClass:true,
                items: 1,
        ...
        // Mouse Hover Efect 
        demoMouseIn: function() {
            $('.single-home-page').hover(
                function() {
                    $('.single-home-page').addClass("overlay");
                    $(this).removeClass("overlay");
                },
            );
            $('.single-home-page').mouseleave(function(){
                $('.single-home-page').removeClass("overlay");
            })
        },
        ...
        stopPropagationElements: () => {
            $('.main-menu, .hdr-cart-dtls, .hdr-search').click(function(e) {
                e.stopPropagation()
            })
        },
        ...
        elementHide: () => {
            $(document).click(function() {
                $('.main-menu, .hmbrgr-icon, .hdr-cart-dtls, .order-status').removeClass('active');
                $('.sub-menu,.mega-menu').slideUp().parents('li').removeClass('active');
                $('.single-menu .title').removeClass('active').next().slideUp();
        ...
        init: function() {
            ...
            allfunction.cart_details()
            allfunction.search_toogle()
            allfunction.sticky()
            allfunction.scrollUp()
            allfunction.nice_select()
            allfunction.counter_up()
            allfunction.aboutGallery()
            allfunction.countDown_clock()
            allfunction.foodDetails_slider()
            allfunction.foodReview_slider()
            allfunction.mp_history_table()
            allfunction.cart_table()
            allfunction.shop_category()
            allfunction.range_slider()
            allfunction.hv1Banner_slider()
            allfunction.mouseIn()
            allfunction.magnificPopup()
            allfunction.hv1testimonial_slider()
            allfunction.hv3Banner_slider()
            allfunction.hv3testimonial_slider()
            allfunction.datePiker()
            allfunction.demoMouseIn()
            allfunction.aos_aimation()
            allfunction.gasp_animation()
        },
    }
...
// demo page animation start here
var targetDiv = document.getElementsByClassName("demo-banner-area").length
if (targetDiv) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        let timeline = new TimelineMax();
        timeline
        .from('.d-banner-thumb .thumb', 1, {
            y: 30,
            opacity: 0,
            ease:"power4.out"
        })
        ...
        let scene = new ScrollMagic.Scene({
            triggerElement: '.demo-banner-area',
            duration: '80%',
            triggerHook: 0,
            offset: '0'
        })
        .setTween(timeline)
        .setPin('.demo-banner-area')
        .addTo(controller);
    });
}
// var targetDivHome = document.getElementsByClassName("demo-banner-area").length
// if (targetDivHome) {
//     document.addEventListener('DOMContentLoaded', () => {
//         let controller = new ScrollMagic.Controller();
//         let timeline = new TimelineMax();
//         timeline
//         .from('.demo-home-page-area .demo-section-title', 1, {
//             y: 30,
//             opacity: 0,
//             ease:"power4.out"
//         })
//         .from('.demo-hp-wrapper .single-home-page', 1, {
//             y: 30,
//             stagger: 1, 
//             ease:"power4.out"
//         })
//         let scene = new ScrollMagic.Scene({
//             triggerElement: '.demo-home-page-area',
//             duration: '100%',
//             triggerHook: 0.5,
//             offset: '0'
//         })
...
// demo page animation start here
var targetDiv2 = document.getElementsByClassName("timeline-sec-two").length
if (targetDiv2) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        ...
        timeline2
        .from('.ts-two-shape-3', 1, {
            x: 80,
            y: -50,
            opacity: 0,
            ease:"power4.out"
        })
        .from('.ts-two-shape-4', 1, {
            x: 50,
            y:25,
            opacity: 0,
            ease:"power4.out"
        }, '-=1')
        .from('.ts-two-shape-5', 1, {
            x: -80,
            y:50,
            opacity: 0,
            ease:"power4.out"
        }, '-=1')
        .from('.ts-two-shape-6', 1, {
            x: 80,
            y:-50,
            opacity: 0,
            ease:"power4.out"
        }, '-=1')
        .from('.ts-two-shape-7', 1, {
            x: -50,
            y:-80,
            opacity: 0,
            ease:"power4.out"
        }, '-=1')
        .from('.ts-two-shape-2', 1, {
            x: -50,
            y:30,
            opacity: 0,
            ease:"power4.out"
        ...
        let scene2 = new ScrollMagic.Scene({
            triggerElement: '.timeline-sec-two',
            duration: '100%',
            triggerHook: 0,
            offset: '0'
        })
        .setTween(timeline2)
        .setPin('.timeline-sec-two')
        .addTo(controller);
    });
}

// demo page animation start here
var targetDivlist = document.getElementsByClassName("tween-home-area").length
if (targetDivlist) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        // timeline section two
        let timeline2 = new TimelineMax();
        timeline2
        .from('.tween-home-wrap .tween-home', 1, {
            y: -50,
            opacity: 0,
            stagger: 0.5,
            ease:"power4.out"
        ...
        let scene2 = new ScrollMagic.Scene({
            triggerElement: '.tween-home-area',
            duration: '100%',
            triggerHook: 0.9,
            offset: '0'
        })
...
// demo page animation start here
var targetDiv3 = document.getElementsByClassName("about-area").length
if (targetDiv3) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        let timeline3 = new TimelineMax();
        timeline3
        .from('.anime-thumb-about-one', 1, {
            y: 100,
            ease:"power4.out"
        })
        .from('.anime-thumb-about-two', 1, {
            scale:0.5,
            x: 50,
            opacity: 0,
            ease:"power4.out"
        ...
        let scene3 = new ScrollMagic.Scene({
            triggerElement: '.about-area',
            duration: '100%',
            triggerHook: 0.6,
            offset: '0'
        })
        .setClassToggle('.about-wrapper' , 'show-animation')
        .setTween(timeline3)
        .addTo(controller);
        
    });
}
var targetDiv4 = document.getElementsByClassName("hv1-testimonial-area").length
if (targetDiv4) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        let timeline4 = new TimelineMax();
        timeline4
        .from('.hv1-testimonial-wrap .shape-1', 1, {
            x: -100,
            ease:"power4.out"
        })
        .from('.hv1-testimonial-wrap .shape-2', 1, {
            x: -100,
            ease:"power4.out"
        },'-=1')
        .from('.hv1-testimonial-wrap .shape-3', 1, {
            x: -100,
            ease: Power3.easeInOut
        },'-=1')
        .from('.hv1-testimonial-wrap .shape-4', 1, {
            x: 100,
            ease:"power4.out"
        },'-=1')
        .from('.hv1-testimonial-wrap .shape-5', 1, {
            x: 100,
            ease: Power3.easeInOut
        },'-=1')
        let scene4 = new ScrollMagic.Scene({
            triggerElement: '.hv1-testimonial-area',
            duration: '100%',
            triggerHook: 0.8,
            offset: '0'
        })
        .setTween(timeline4)
        //.setPin('.hv1-testimonial-wrap')
        .addTo(controller);
        
    });
}
var targetDiv5 = document.getElementsByClassName("hv2-about-area").length
if (targetDiv5) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        let timeline4 = new TimelineMax();
        timeline4
        .from('.hv2-about-thumb .thumb', 1, {
            scale:0.8,
            opacity:0,
            ease:"power4.out"
        })
        .from('.hv2-about-content:before', 1, {
            x: -50,
            opacity:0,
            ease:"power4.out"
        }, '-=1')
        .from('.hv2-about-thumb .shape-02', 1, {
            x: 30,
            y:30,
            opacity:0,
            ease:"power4.out"
        })
        .from('.hv2-about-thumb .shape-03', 1, {
            y:30,
            opacity:0,
            ease:"power4.out"
        },'-=0.5')
        .from('.hv2-about-thumb .shape-01', 1, {
            x: -30,
            y:-30,
            opacity:0,
            ease:"power4.out"
        ...
        let scene4 = new ScrollMagic.Scene({
            triggerElement: '.hv2-about-area',
            duration: '100%',
            triggerHook: 0,
            offset: '-50'
        })
        .setTween(timeline4)
        .setPin('.hv2-about-area')
        .addTo(controller);
        
    });
}
var targetDiv6 = document.getElementsByClassName("hv2-reservation-area ").length
if (targetDiv6) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        let timeline4 = new TimelineMax();
        timeline4
        .from('.hv2-reservation-area .shape-1', 1, {
            x:-100,
            opacity:0,
            ease:"power4.out"
        })
        .from('.hv2-reservation-area .shape-2', 1, {
            x:100,
            opacity:0,
            ease:"power4.out"
        },'=-1')
        ...
        let scene4 = new ScrollMagic.Scene({
            triggerElement: '.hv2-reservation-area ',
            duration: '100%',
            triggerHook: 0.8,
            offset: '0'
        })
...
var targetDiv7 = document.getElementsByClassName("hv4-banner-area ").length
if (targetDiv7) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        let timeline4 = new TimelineMax();
        timeline4
        .from('.hv4-banner-thumb .thumb', 1, {
            scale:0.85,
            ease:"power4.out"
        })
        .from('.hv4-banner-thumb .tShape-1', 1, {
            scale:0.5,
            x:-50,
            opacity:0,
            ease:"power4.out"
        })
        .from('.hv4-banner-thumb .tShape-2', 1, {
            scale:0.5,
            x:50,
            opacity:0,
            ease:"power4.out"
        })
        .from('.hv4-banner-thumb .tShape-3', 1, {
            scale:0.5,
            x:50,
            opacity:0,
            ease:"power4.out"
        ...
        let scene4 = new ScrollMagic.Scene({
            triggerElement: '.hv4-banner-area ',
            duration: '100%',
            triggerHook: 0,
            offset: '0'
        })
        .setTween(timeline4)
        .setPin('.hv4-banner-area')
        .addTo(controller);
        
    });
}
var targetDiv7 = document.getElementsByClassName("hv4-about-area ").length
if (targetDiv7) {
    document.addEventListener('DOMContentLoaded', () => {
        let controller = new ScrollMagic.Controller();
        let timeline4 = new TimelineMax();
        timeline4
        .from('.hv4-about-thumb .thumb-01', 1, {
            y:-65,
            ease:"power4.out"
        })
        .from('.hv4-about-thumb .thumb-03', 1, {
            y:65,
            ease:"power4.out"
        }, '=-0.5')
        
        let scene4 = new ScrollMagic.Scene({
            triggerElement: '.hv4-about-area ',
            duration: '100%',
            triggerHook: 0,
            offset: '0'
        })
        .setTween(timeline4)
        .setPin('.hv4-about-area')
        .addTo(controller);
